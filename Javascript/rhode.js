...
import { dataProfil, sortJson, showMedia, newContainer,  createElements, openModal,closeModal,sortMedia, hiddenElement, closeLightbox, pictureInLightbox, videoInLightbox} from "./function.js";
...
fetch("./data.json")
  ...
  .then((data) => {
    ...
    const urlMedia = rhode.map((item) => (item.image != undefined ? "ressources/Rhode/" + item.image : "ressources/Rhode/" + item.video));
    let keyPicture = null;
